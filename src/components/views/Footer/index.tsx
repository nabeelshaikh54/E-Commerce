...
const Footer = () => {
    return (
        <footer className="text-gray-500 body-font">
            <div className="container px-2 md:px-4 py-24 mx-auto flex md:items-start text-start  lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
                <div className="space-y-6 w-96 flex-shrink-0 md:mx-0 mx-auto text-start md:text-left">
                    <Link href={"/"} className="flex title-font font-medium items-start md:justify-start justify-start text-gray-900">
                        <Image width={180} height={180} src={"/Logo.webp"} alt="Logo" />
                    </Link>
                ...
                <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-start gap-8">
                    <div className="lg:w-1/4 md:w-1/2 w-full px-0 md:px-4">
                        <h2 className="title-font mb-3 text-xl font-bold">Company</h2>
                    ...
                    <div className="lg:w-1/4 md:w-1/2 w-full px-0 md:px-4">
                        <h2 className="title-font mb-3 text-xl font-bold">Support</h2>
                        <nav className="list-none mb-10 space-y-3">
                            <li>
                    ...
                    <div className="lg:w-1/4 md:w-1/2 w-full px-0 md:px-4">
                        <h2 className="title-font mb-3 text-xl font-bold">Contact</h2>
                        <nav className="list-none mb-10 space-y-3">
                            <li>
            ...
            <div className="bg-white">
                <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                    <p className="text-gray-500 text-sm text-center sm:text-left">Copyright © 2022 Dine Market</p>
