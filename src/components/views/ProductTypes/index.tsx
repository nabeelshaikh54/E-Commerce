...
import { event2 } from "@/components/assets";
import { event3 } from "@/components/assets";
  ...
  return (
    <div className="py-16 px-10 space-y-10">
      ...
      <div className="text-center space-y-3">
        ...
        <h3 className="text-3xl md:text-4xl text-gray-800 font-bold">Our Promotions Events</h3>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 text-gray-800 mx-auto">
        ...
        <div className="py-9 text-white w-full col-auto md:col-span-2 bg-cat2 flex flex-col justify-center items-center space-y-3">
          <h3 className="font-extrabold text-3xl md:text-4xl">GET 30% Off</h3>
          <p>USE PROMO CODE</p>
          <button
            aria-label="Redirect user to Dine Week End Sale"
            className="py-1 px-4 md:px-8 text-lg font-medium bg-[#474747] rounded-lg tracking-widest"
          >
            DINEWEEKENDSALE
          </button>
        </div>
